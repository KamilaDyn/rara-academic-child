<?php
function rara_academic_customize_register_child($wp_customize)
{
    ...
    /** Option list of slider post */
    $post_args = array(
        'post_type' => 'slider',
    );
    $options_slider_post = array();
    $options_slider_lists = get_posts($post_args);
    $options_slider_post[''] = __('Choose Slider Post', 'rara-academic');
    foreach ($options_slider_lists as $slider) {
        $options_slider_post[$slider->ID] = $slider->post_title;
    }
    ...
    $wp_customize->add_control(
        'rara_academic_slider_auto',
        array(
            'label' => __('Enable Slider Auto Transition', 'rara_academic'),
            'section' => 'rara_academic_banner_settings',
            'type' => 'checkbox',
        )
    );
    ...
    $wp_customize->add_control(
        'rara_academic_slider_loop',
        array(
            'label' => __('Enable Slider Loop', 'rara_academic'),
            'section' => 'rara_academic_banner_settings',
            'type' => 'checkbox',
        )
    );
    ...
    $wp_customize->add_control(
        'prara_academic_slider_control',
        array(
            'label' => __('Enable Slider Control', 'rara_academic'),
            'section' => 'rara_academic_banner_settings',
            'type' => 'checkbox',
        )
    );
    ...
    $wp_customize->add_control(
        'rara_academic_slider_caption',
        array(
            'label' => __('Enable Slider Caption', 'rara_academic'),
            'section' => 'rara_academic_banner_settings',
            'type' => 'checkbox',
        )
    );
    ...
    /** Slider Speed */
    $wp_customize->add_setting(
        'rara_academic_slider_speed',
        array(
            'default' => '7000',
            'sanitize_callback' => 'rara_academic_sanitize_number_absint',
        )
    );
    ...
    $wp_customize->add_control(
        'rara_academic_slider_speed',
        array(
            'label' => __('Slider Speed', 'rara_academic'),
            'section' => 'rara_academic_banner_settings',
            'type' => 'text',
        )
    );
    ...
    $wp_customize->add_control(
        'rara_academic_animation_speed',
        array(
            'label' => __('Pause Speed', 'rara_academic'),
            'section' => 'rara_academic_banner_settings',
            'type' => 'text',
        )
    );
    ...
    $wp_customize->add_control(
        'rara_academic_banner_post_one',
        array(
            'label' => __('Select Banner Slide 1', 'rara-academic'),
            'section' => 'rara_academic_banner_settings',
            'type' => 'select',
            'choices' =>   $options_slider_post,
        )
    );

    /** Banner Post 2*/
    $wp_customize->add_setting(
        'rara_academic_banner_post_two',
        array(
            'default' => '',
            'sanitize_callback' => 'rara_academic_sanitize_select',
        )
    ...
    $wp_customize->add_control(
        'rara_academic_banner_post_two',
        array(
            'label' => __('Select Banner Slide 2', 'rara-academic'),
            'section' => 'rara_academic_banner_settings',
            'type' => 'select',
            'choices' =>  $options_slider_post,
        )
    ...
    /** Banner Post 3*/
    $wp_customize->add_setting(
        'rara_academic_banner_post_three',
        array(
            'default' => '',
            'sanitize_callback' => 'rara_academic_sanitize_select',
        )
    ...
    $wp_customize->add_control(
        'rara_academic_banner_post_three',
        array(
            'label' => __('Select Banner Slide 3', 'rara-academic'),
            'section' => 'rara_academic_banner_settings',
            'type' => 'select',
            'choices' =>   $options_slider_post,
        )
    ...
    /** Post Fourth*/
    $wp_customize->add_setting(
        'rara_academic_popular_course_post_four',
        array(
            'default' => '',
            'sanitize_callback' => 'rara_academic_sanitize_select',
        )
    ...
    function rara_academic_sanitize_number_absint($number, $setting)
    {
...
add_action('customize_register', 'rara_academic_customize_register_child');
