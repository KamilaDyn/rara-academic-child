...
<div id="primary" class="content-area">
    <main id="main" class="site-main" role="main">
        ...
        <?php else : ?>
            <div>
                <h1>Strefa studenta <span>Grupa Beginner</span></h1>
                <p> Wygląda na to, że nie jesteś w tej grupie , brak dostępu do tego panelu.
                    Poszukaj swojej grupy w zakładce Strefa studenta.</p>
                </p> Jesli nie jesteś uczestnikiem mojego kursu, a chcesz dobrze nauczyć się się języka angielskiego napisz do mnie.
                <a href="" class="learn more">Kontakt</a>
                </p>
