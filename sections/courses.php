...
$post_four      = get_theme_mod('rara_academic_popular_course_post_four');
...
?>
	...
	<section class="popular-courses" id="grupy">
		<div class="container">
							...
							<article class="post">
								<a href="<?php the_permalink(); ?>" class="post-thumbnail">
									...
									if (has_post_thumbnail()) {
										the_post_thumbnail('rara-academic-courses-blog');
									} else {
										rara_academic_get_fallback_svg('rara-academic-courses-blog');
									} ?>
								</a>
